 ...
 */
public class CreateSHA_2_Slow_Salted_Examples {
    ...
    public void createSH2_examples(){
        ...
        Persister persister = new FilePersister("sha_2_slow_user_salted.properties");
    ...
    private void addUsersSalted(String user, String password, Users users, Hasher hasher) {
        ...
        users.addUser(user, hasher.hashSha_2(password+salt, Login.HASH_RERUNS));
